...
},{"./timer":4,"./user-actions":5}],3:[function(require,module,exports){
var Board = require('./board')

var Settings = {
    // do ajax-y get to get letters on page, instead of passing from server?
   letters: ['G','C','P','W','H','T','B','A','O','T','D','I','D','T','E','M'],
    board: [
      [0,0], [0,1], [0,2], [0,3],
      [1,0], [1,1], [1,2], [1,3],
      [2,0], [2,1], [2,2], [2,3],
